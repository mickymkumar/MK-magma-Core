...
# Run main LTE CLI (adjust if you have a different main script)
python3 agw_health_cli.py &

# Start other LTE services as needed
# python3 pipelined_cli.py &
# python3 mobility_cli.py &
